...
$consulUrl = "https://releases.hashicorp.com/consul/0.7.5/consul_0.7.5_windows_amd64.zip"
$uiUrl = "https://releases.hashicorp.com/consul/0.7.5/consul_0.7.5_web_ui.zip"
...
Move-Item -Path "C:\opt\consul\static" "C:\opt\consul\ui" -Force
